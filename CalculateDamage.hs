module Foreign.PokemonGame.CalculateDamage where
...
-- subtract the number of healings remaining
...
calcDmg pokemonA attMove pokemonHit =
    ...
    let dmg = (fromIntegral (attackDivDefence * pow)) * modifier / 55
    let roundedDmg = round dmg + 2
